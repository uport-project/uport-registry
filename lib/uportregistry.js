...
var DEFAULT_REGISTRY_ADDRESS = '0x42b5b3ef3f021d3ef91070abf176978cb0fee676';
  ...
  */
  ...
  _createClass(UportRegistry, [{
    ...
    value: function setAttributes(personaInfo, txData) {
      ...
      return new Promise(function (accept, reject) {
        _this.ipfs.addJSON(personaInfo, function (err, result) {
          ...
          _this.registryContract.set('uPortProfileIPFS1220', txData.from, RegSafeIpfs, txData).then(function (tx) {
            accept(tx);
          }).catch(reject);
        });
      });
    ...
    value: function getAttributes(personaAddress) {
      ...
      return new Promise(function (accept, reject) {
        _this2.registryContract.get.call('uPortProfileIPFS1220', personaAddress, personaAddress).then(function (ipfsHashHex) {
